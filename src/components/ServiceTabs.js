...
export default function ServiceTabs({ services }) {
  ...
  const service = services.items[activeTab];

  return (
    <section className="bg-white py-5">
      <div className="container">
        <div className="row" data-aos="fade-up" data-aos-duration="1000">
          <p className="text-uppercase text-muted mb-2 text-center">{services.shortTitle}</p>
          <h2 className="fw-bold mb-5 text-center text-uppercase">{services.mainTitle}</h2>
        </div>

        <div className="row align-items-center">
          {/* Tabs */}
          <div className="col-lg-3 mb-4 mb-lg-0" data-aos="fade-right" data-aos-duration="1200">
            <ul className="nav flex-column d-flex justify-content-center align-items-center align-items-lg-start">

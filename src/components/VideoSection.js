    ...
    <section className="py-5"  data-aos="fade-up"
      ...
      <div className="container">
        ...
        >
          ...
          <div className="position-absolute top-50 start-0 translate-middle-y w-100 ">
            <div className="row align-items-center" >
              {/* Left Text */}
              <div className="col-md-5 offset-md-2 ps-5 px-md-5"   data-aos="fade-right"
        data-aos-duration="1500">
              ...
              {/* Right Play Icon */}
              <div className="col-md-2 d-flex justify-content-center align-items-center  px-md-5"  data-aos="fade-left"
        data-aos-duration="1500">
                <a
                  href="#"

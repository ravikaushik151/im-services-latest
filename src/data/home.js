const homeData = {
  heroSlides: [
    {
      id: 1,
      heading: "Power Your Brand with India's Premier Generative Search Optimization (GEO) Agency",
      subheading: 'From ChatGPT to Google SGE, we engineer content that dominates AI-driven discovery.',
      image: '/img/slider1.jpg',
      cta: 'Claim Your Free GEO Visibility Audit',
      ctaLink: '#',
    },
    {
      id: 2,
